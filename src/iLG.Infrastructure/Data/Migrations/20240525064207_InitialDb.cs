        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Height", "[Height] >= 0 AND [Height] <= 300");
                    table.ForeignKey(
                        name: "FK_UserInfos_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInfos_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInfos_Relationships_RelationshipId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserMatches_UserInfos_UserInfoId",
                        column: x => x.UserInfoId,
                        principalTable: "UserInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInfos_CompanyId",
                table: "UserInfos",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInfos_JobId",
                table: "UserInfos",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInfos_RelationshipId",
                table: "UserInfos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMatches_UserInfoId",
                table: "UserMatches",
                column: "UserInfoId");
